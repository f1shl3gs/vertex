...
pub struct DomainBlockIoTuneParameters {
...
impl DomainStatsRecord {
    ...
    pub fn vcpu_wait_and_delay(&self, vcpu: u32) -> Result<(u64, u64), Error> {
        unsafe {
            let wait = get_u64(
                (*self.ptr).params,
                (*self.ptr).nparams,
                &format!("vcpu.{}.wait", vcpu),
            )?;
            let delay = get_u64(
                (*self.ptr).params,
                (*self.ptr).nparams,
                &format!("vcpu.{}.delay", vcpu),
            )?;
    ...
    pub fn block_stats(&self) -> Result<Vec<DomainBlockStats>, Error> {
        unsafe {
            let n = get_u32(
                (*self.ptr).params,
                (*self.ptr).nparams,
            ...
            for i in 0..n {
                array.push(DomainBlockStats {
                    name: get_string(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.name", i),
                    )?,
                    backing_index: get_u32(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.backingIndex", i),
                    )?,
                    path: get_string(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                    ...
                    read_requests: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.rd.reqs", i),
                    )?,
                    read_bytes: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.rd.bytes", i),
                    )?,
                    read_time: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.rd.times", i),
                    )?,
                    write_requests: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.wr.reqs", i),
                    )?,
                    write_bytes: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.wr.bytes", i),
                    )?,
                    write_time: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.wr.times", i),
                    )?,
                    flush_requests: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.fl.reqs", i),
                    )?,
                    flush_time: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.fl.times", i),
                    )?,
                    errors: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.errors", i),
                    )?,
                    allocation: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.allocation", i),
                    )?,
                    capacity: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.capacity", i),
                    )?,
                    physical: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("block.{}.physical", i),
                    )?,
                })
            }
    ...
    pub fn get_block_io_tune(&self, disk: &str) -> Result<DomainBlockIoTuneParameters, Error> {
        unsafe {
    ...
    pub fn network_stats(&self) -> Result<Vec<DomainNetworkStats>, Error> {
        unsafe {
            let n = get_u32(
                (*self.ptr).params,
                (*self.ptr).nparams,
            ...
            for i in 0..n {
                array.push(DomainNetworkStats {
                    ...
                    rx_bytes: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.rx.bytes", i),
                    )?,
                    rx_packets: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.rx.pkts", i),
                    )?,
                    rx_errors: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.rx.errs", i),
                    )?,
                    rx_drop: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.rx.drop", i),
                    )?,
                    tx_bytes: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.tx.bytes", i),
                    )?,
                    tx_packets: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.tx.pkts", i),
                    )?,
                    tx_errors: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.tx.errs", i),
                    )?,
                    tx_drop: get_u64(
                        (*self.ptr).params,
                        (*self.ptr).nparams,
                        &format!("net.{}.tx.drop", i),
                    )?,
                })
            }
