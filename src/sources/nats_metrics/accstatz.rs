    ...
    for account in resp.account_statz {
        ...
        metrics.extend([
            Metric::gauge_with_tags(
                "gnatsd_accstatz_current_connections",
                "",
                account.conns,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_total_connections",
                "",
                account.total_conns,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_subscriptions",
                "",
                account.num_subscriptions,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_leaf_nodes",
                "",
                account.leaf_nodes,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_sent_messages",
                "",
                account.sent.msgs,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_sent_bytes",
                "",
                account.sent.bytes,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_received_messages",
                "",
                account.received.msgs,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_received_bytes",
                "",
                account.received.bytes,
                tags.clone(),
            ),
            Metric::gauge_with_tags(
                "gnatsd_accstatz_slow_consumers",
                "",
