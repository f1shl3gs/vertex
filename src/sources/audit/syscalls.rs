...
mod tests {
    ...
    fn lookup() {
        ...
        assert_eq!(syscall_name("321"), Some("bpf"));
        assert_eq!(syscall_name("457"), Some("statmount"));
        assert_eq!(syscall_name("48"), Some("shutdown"));
        assert_eq!(syscall_name("127"), Some("rt_sigpending"));
