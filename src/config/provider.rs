...
use crate::signal;
use crate::config::{ExampleError, GenerateConfig};
...
pub trait ProviderConfig: core::fmt::Debug + Send + Sync + dyn_clone::DynClone {
    ...
    async fn build(&mut self, signal_handler: &mut signal::SignalHandler) -> Result<Builder, Vec<String>>;
...
where
    inventory::iter<ProviderDescription>: std::iter::IntoIterator<Item=&'static ProviderDescription>
{
